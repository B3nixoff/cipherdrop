...
Ephemeral one-to-one chat built with Next.js 16, Firebase Auth, Firestore, Firebase Realtime Database, WebRTC, and the Web Crypto API.
...
- Unpacked folder: `dist-desktop/win-unpacked`
- Executable: `dist-desktop/win-unpacked/CipherDrop.exe`
- Zipped artifact: `dist-desktop/CipherDrop-win-unpacked.zip`
